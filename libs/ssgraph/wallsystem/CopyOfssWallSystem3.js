	...
	return function (client, data, myParent, x, y) {
		...
		this.renderWallEndPost = function (wdata) {
			...
			case "90-W-S":
				...
				extrusion1.x1 = x;
				extrusion1.y1 = y;
				extrusion1.x2 = extrusion1.x1 + extrusion1.d;
				...
				extrusion1.svg = extrusion1.container.polygon([
					...
					extrusion1.x1, extrusion1.y2,
					extrusion1.x2, extrusion1.y3,
					extrusion1.x2, extrusion1.y1
				]);
				...
				extrusion2.y2 = extrusion2.y1 - extrusion2.d;
				extrusion2.x3 = extrusion2.x1 + extrusion2.d;
				extrusion2.svg = extrusion2.container.polygon([
					extrusion2.x1, extrusion2.y1,
					extrusion2.x2, extrusion2.y1,
					extrusion2.x2, extrusion2.y2,
					extrusion2.x3, extrusion2.y2
				]);
				extrusion2.svg.attr({
					fill: ssBase.color[color].htmlcolor,
					"stroke": "#000",
				...
				this.lastx = extrusion2.x2;
				this.lasty = extrusion2.y1;
			...
			case "45-W-SW":
				...
				extrusion1.x2 = extrusion1.x1 + extrusion1.d;
				extrusion1.y2 = extrusion1.y1 + extrusion1.w;
				extrusion1.y3 = extrusion1.y2 - (legd/2);
				extrusion1.svg = extrusion1.container.polygon([
					extrusion1.x1, extrusion1.y1,
					extrusion1.x1, extrusion1.y2,
					extrusion1.x2, extrusion1.y3,
				...
				var leg = ssMath.calcRightTriangleLeg(extrusion1.w);
				var legd = ssMath.calcRightTriangleLeg(extrusion1.d);
				extrusion2.w = w;
				extrusion2.d = d;
				...
				extrusion2.y3 = extrusion2.y2 - (legd/2);
				extrusion2.x4 = extrusion1.x2;
			...
			case "45-SW-S":
				...
				extrusion1.y2 = extrusion1.y1 + extrusion1.w;
				extrusion1.x3 = extrusion1.x2 + (legd/2);
				extrusion1.y3 = extrusion1.y2 - (legd/2);
				extrusion1.x4 = extrusion1.x1 + d;
				extrusion1.y4 = extrusion1.y1 - (legd/2);
				extrusion1.svg = extrusion1.container.polygon([
					extrusion1.x1, extrusion1.y1,
			...
			case "90-S-E":
				...
				extrusion1.y2 = extrusion1.y1 + extrusion1.d;
				extrusion1.x3 = extrusion1.x1 + extrusion1.d;
				extrusion1.y3 = extrusion1.y1;
				extrusion1.svg = extrusion1.container.polygon([
					extrusion1.x1, extrusion1.y1,
					extrusion1.x1, extrusion1.y2,
					extrusion1.x2, extrusion1.y2,
					extrusion1.x3, extrusion1.y1
				]);
				extrusion1.svg.attr({
					fill: ssBase.color[color].htmlcolor,
					"stroke": "#000",
				...
				extrusion2.y1 = extrusion1.y2;
				extrusion2.x2 = extrusion2.x1 - extrusion2.d;
				extrusion2.y2 = extrusion2.y1 - extrusion2.w;
				extrusion2.x3 = extrusion2.x1 + extrusion2.d;
				extrusion2.y3 = extrusion2.y1 - extrusion2.d;
				extrusion2.svg = extrusion2.container.polygon([
					extrusion2.x1, extrusion2.y1,
					extrusion2.x1, extrusion2.y2,
					extrusion2.x2, extrusion2.y2,
					extrusion2.x2, extrusion2.y3
				]);
				extrusion2.svg.attr({
					fill: ssBase.color[color].htmlcolor,
					"stroke": "#000",
				...
				extrusion.x1 = x;
				extrusion.y1 = y;
				extrusion.x2 = extrusion2.x1;
				extrusion.y2 = extrusion2.y2;

				this.lastx = extrusion2.x1;
				this.lasty = extrusion2.y2;
...
//			this.extrusions.push(extrusion);
		...
		this.renderSection = function (direction, color, w, d, l) {
			...
			case "SW":
				...
				extrusion.y2 = extrusion.y1 + extrusion.w;
				extrusion.x3 = extrusion.x2 + extrusion.d;
				extrusion.y3 = extrusion.y2 - (legd/2);
				extrusion.x4 = extrusion.x1 + extrusion.d;
				extrusion.y4 = extrusion.y3 - w;
				extrusion.svg = extrusion.container.polygon([extrusion.x1, extrusion.y1,
					extrusion.x2, extrusion.y2,
