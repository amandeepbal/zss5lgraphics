sap.ui.define([
	...
	return function (myParent, x, y) {
		...
		this.render = function () {
			...
			this.screeno.hw = this.getParent().paneo.w / 2;
			...
			this.screeno.y2 = this.y + this.screeno.rh;
			this.screeno.y3 = this.screeno.y2 - this.screeno.rh;
			this.screeno.y4 = this.screeno.y2 - this.screeno.lh;
			...
			this.screeno.x3 = this.screeno.x1 + this.screeno.hw;
			this.screeno.svg = this.screeno.container.polygon([
					...
					this.screeno.x3, this.screeno.y4,
				]);
