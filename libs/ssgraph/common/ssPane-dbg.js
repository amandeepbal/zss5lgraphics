sap.ui.define([
	...
	return function(myParent,x,y) {
		...
		this.render = function() {
            ...
            var hasSpreader = false;
             if(data.model["SPREADER.BAR"] !=undefined){
               if(data.model["SPREADER.BAR"].value){hasSpreader = true;}
 	        }
            ...
            if(!isHorizontal && showGlassMarks && hasSpreader){
              var  centerx = this.x + (this.paneo.w/4);
              var  centery = this.y + (this.paneo.h/2);
			  this.paneo.svgx = this.paneo.container.line(centerx+5,centery-15,centerx-15,centery+5);
			  this.paneo.svgx.attr({fill: ssBase.color["DG"].htmlcolor,"stroke": "#000", "stroke-width": 1});
              ...
              centerx = this.x + ((this.paneo.w/4) * 3);
              centery = this.y + (this.paneo.h/2);
			  this.paneo.svgx = this.paneo.container.line(centerx+5,centery-15,centerx-15,centery+5);
			  this.paneo.svgx.attr({fill: ssBase.color["DG"].htmlcolor,"stroke": "#000", "stroke-width": 1});
            ...
            if(isHorizontal && showGlassMarks && hasSpreader){
              var  centerx = this.x + (this.paneo.w/2);
              var  centery = this.y + (this.paneo.h/4);
			  this.paneo.svgx = this.paneo.container.line(centerx+5,centery-15,centerx-15,centery+5);
			  this.paneo.svgx.attr({fill: ssBase.color["DG"].htmlcolor,"stroke": "#000", "stroke-width": 1});
              ...
              centery = this.y + ((this.paneo.h/4) * 3);
			  this.paneo.svgx = this.paneo.container.line(centerx+5,centery-15,centerx-15,centery+5);
			  this.paneo.svgx.attr({fill: ssBase.color["DG"].htmlcolor,"stroke": "#000", "stroke-width": 1});
            ...
            if(isHorizontal && showVinylMarks && hasSpreader){
              var  centerx = this.x + (this.paneo.w/2);
              var  centery = this.y + (this.paneo.h/4);
