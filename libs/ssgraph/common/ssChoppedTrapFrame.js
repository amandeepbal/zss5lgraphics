sap.ui.define([
	...
	return function (myParent, x, y) {
		...
		this.render = function () {
			...
			if (data.model["TOP.LEG"] != undefined) {
				tl = Number(data.model["TOP.LEG"].value);
				if (tl == undefined) {
					tl = 1;
				}
			}
			...
			this.frameo.y2 = this.frameo.y1 + lh;
			this.frameo.y3 = this.frameo.y2 - rh;

			if (lh > rh) {
				this.frameo.x3 = this.frameo.x1 + tl;
				this.frameo.svg = this.frameo.container.polygon([
					this.frameo.x3, this.frameo.y1,
				...
				this.frameo.x3 = this.frameo.x2 - tl;
				this.frameo.svg = this.frameo.container.polygon([
					this.frameo.x1, this.frameo.y1,
					this.frameo.x1, this.frameo.y2,
					this.frameo.x2, this.frameo.y2,
					this.frameo.x2, this.frameo.y3,
					this.frameo.x3, this.frameo.y3,
				]);
...
//				irh = ilh - drop;
			...
			this.framei.y2 = this.framei.y1 + this.framei.lh;
			this.framei.y3 = this.framei.y1 + (this.framei.lh - this.framei.rh);

			if (lh > rh) {
				this.framei.x3 = this.framei.x1 + this.framei.tl;
				this.framei.svg = this.frameo.container.polygon([
					this.framei.x3, this.framei.y1,
				...
				this.framei.x3 = this.framei.x2 - this.framei.tl;
				this.framei.svg = this.frameo.container.polygon([
					this.framei.x1, this.framei.y1,
					this.framei.x1, this.framei.y2,
					this.framei.x2, this.framei.y2,
					this.framei.x2, this.framei.y3,
					this.framei.x3, this.framei.y3,
				]);
