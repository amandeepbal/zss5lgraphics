sap.ui.define([
	...
	return function(myParent,x,y) {
		...
		this.frameo = {container:undefined, x:0, y:0};
		this.framei = {container:undefined, x:0, y:0};
		this.sashes = [];
		...
		this.render = function() {
			...
			this.frameo = {container: undefined, svg: undefined};
			...
			this.frameo.svg = this.frameo.container.polygon([this.frameo.x1, this.frameo.y1,
			...
			this.framei.svg = this.frameo.container.polygon([this.framei.x1, this.framei.y1,
