sap.ui.define([
...
], function (ssMath, core, ssBase, ssTrapPane, ssSpreaderBar) {
	return function (myParent, x, y, w, lh, rh) {
		...
		this.render = function () {
			...
			this.sasho.svg = this.sasho.container.polygon([this.sasho.x1, this.sasho.y1,
			...
			this.sashi.svg = this.sashi.container.polygon([this.sashi.x1, this.sashi.y1,
			...
			this.pane = new ssTrapPane(this, this.sashi.x1, this.sashi.y1, this.sashi.w, this.sashi.lh, this.sashi.rh).render();
