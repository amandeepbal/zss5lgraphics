sap.ui.define([
	...
	return function(myParent,x,y) {
		...
		this.render = function() {
			...
			this.frameo.svg.attr({fill: ssBase.color[color].htmlcolor,"stroke": "#000", "stroke-width": 1});
			...
			this.framei.svg.attr({fill:ssBase.color[color].htmlcolor,"stroke": "#000", "fill-opacity": "0.1","stroke-width": 1});
