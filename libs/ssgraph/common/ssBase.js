...
sap.ui.define([
	...
	return {
		color: {
			...
			"SWS":{htmlcolor: "#ede6dc"},
			"SWP":{htmlcolor: "#fff9f1"},
			"SAT":{htmlcolor: "#494647"}, 
			"SSA":{htmlcolor: "#97867f"}, 
			"SSS":{htmlcolor: "#6b5e52"}, 
			"SMT":{htmlcolor: "#4b3d3c"},
			"SBC":{htmlcolor: "#632718"},
			"SWG":{htmlcolor: "#e9ebe7"},
			"SMM":{htmlcolor: "#3b3b40"}, 
			"SBP":{htmlcolor: "#000000"},
			"SBB":{htmlcolor: "#271c1a"},
