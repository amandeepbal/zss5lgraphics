sap.ui.define([
	...
	"zss5lgraphics/libs/ssgraph/common/ssChoppedTrapFrame",
	"zss5lgraphics/libs/ssgraph/common/ssChoppedTrapSash",
	"zss5lgraphics/libs/ssgraph/common/ssPane"
], function(ssMath, core, ssBase, ssChoppedTrapFrame, ssChoppedTrapSash, ssPane) {
	...
	return function(client, data, myParent, x, y) {
		...
		this.render = function() {
			...
			ssMath.calcChoppedTrapezoid(data.model);
			...
			this.frame = new ssChoppedTrapFrame(this, this.x, this.y).render();
			...
			var sash = new ssChoppedTrapSash(this, this.frame.framei.x1, this.frame.framei.y1, this.frame.framei.w, this.frame.framei.lh, this.frame.framei
