sap.ui.define([
	...
	return function (client, data, myParent, x, y) {
		...
		this.showDimensions = function (aroof, x, y) {
			switch (aroof.roofStyle) {
			case "S":
				this.dimensionsprojection = ssBase.showLabel(this.container, aroof.core.formatMeasurement(aroof.model['LENGTH'].value), 'V',
					x + 10,
					aroof.y1,
					x + 10,
					aroof.y2
