sap.ui.define([
	...
	return function (client, data, myParent, x, y) {
		...
		this.showStudioDimensions = function () {
			...
			this.dimensionsprojection = ssBase.showLabel(this.container, core.formatMeasurement(data.model['LENGTH'].value), 'V', 0, ty1, 0, ty2);
			this.dimensionswidth = ssBase.showLabel(this.container, core.formatMeasurement(data.model['WIDTH'].value), 'H', tx1, ty2, tx2, ty2);
			return;

			this.dimensionsprojection.container = this.container;
			this.dimensionsprojection.svg1 = this.dimensionsprojection.container.line(0, ty1, 20, ty1);
			this.dimensionsprojection.svg2 = this.dimensionsprojection.container.line(10, ty1, 10, ty2);
			this.dimensionsprojection.svg3 = this.dimensionsprojection.container.line(0, ty2, 20, ty2);

			this.dimensionsprojection.svg1.attr({
				fill: "#000",
				"stroke": "#0000FF",
				"stroke-width": 1
			});
			this.dimensionsprojection.svg2.attr({
				fill: "#000",
				"stroke": "#0000FF",
				"stroke-width": 1
			});
			this.dimensionsprojection.svg3.attr({
				fill: "#000",
				"stroke": "#0000FF",
				"stroke-width": 1
			});
			var tpos = (ty2 / 2) - 15;
			this.dimensionsprojection.svg4 = this.dimensionsprojection.container.rect(40, 20);
			this.dimensionsprojection.svg4.attr({
				fill: '#FFFFFF',
				"stroke": "#0000FF",
				"stroke-width": 1
			});
			this.dimensionsprojection.svg4.x(0);
			this.dimensionsprojection.svg4.y(tpos);

			var fl = core.formatMeasurement(data.model['LENGTH'].value);
			this.dimensionsprojection.svg5 = this.dimensionsprojection.container.plain(fl);
			this.dimensionsprojection.svg5.font({
				family: 'Helvetica',
				size: 10,
				anchor: 'middle',
				leading: '1.5em'
			...
			tpos = (ty2 / 2) - 10;
			this.dimensionsprojection.svg5.x(20);
			this.dimensionsprojection.svg5.y(tpos);
