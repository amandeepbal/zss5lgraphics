sap.ui.define([
	...
	return function (client, data, myParent, x, y) {
		...
		this.showStudioDimensions = function () {
			...
			this.dimensionsprojection.svg2 = this.dimensionsprojection.container.line(5, ty1, 10, ty2);
			...
			this.dimensionsprojection.svg4 = this.dimensionsprojection.container.plain(fl);
			this.dimensionsprojection.svg4.transform({
				rotation: 90
			});
			this.dimensionsprojection.svg4.x(20);
			this.dimensionsprojection.svg4.y(ty2 / 2);
		};
