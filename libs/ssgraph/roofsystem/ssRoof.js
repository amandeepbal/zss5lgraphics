sap.ui.define([
	...
	return function (client, data, myParent, x, y) {
		...
		this.renderStudioReceiver = function () {
			...
			var data = core.getModel(this.getData().model.parent, "rsReceiver");
		...
		this.renderStudioFasciaLeft = function () {
			...
			var data = core.getModel(this.getData().model.parent, "rsFasciaLeft");
			if (data === undefined) return;
		...
		this.renderCornerReceiverLeft = function () {
			...
			var data = core.getModel(this.getData().model.parent, "rsReceiverCorner");
			if (data === undefined) return;
		...
		this.renderStudioGutter = function () {
			...
			var data = core.getModel(this.getData().model.parent, "rsGutter");
			if (data === undefined) return;
		...
		this.renderStudioFasciaRight = function () {
			...
			var data = core.getModel(this.getData().model.parent, "rsFasciaRight");
			if (data === undefined) return;
