sap.ui.define([
	...
	return function (client, data, myParent, x, y) {
		...
		this.showStudioDimensions = function () {
			...
			this.dimensionsprojection.svg1 = this.dimensionsprojection.container.line(0, ty1, 10, ty1);
			this.dimensionsprojection.svg2 = this.dimensionsprojection.container.line(5, ty1, 5, ty2);
			this.dimensionsprojection.svg3 = this.dimensionsprojection.container.line(0, ty2, 10, ty2);
