sap.ui.define([
	...
	return function (client, data, myParent, x, y) {
		...
		this.showLabel = function (obj) {
			...
			var sText = this.data.label + "(" + core.formatMeasurement(this.data.model['WIDTH'].value) + " X " +
				core.formatMeasurement(this.data.model['LENGTH'].value);
			this.label = ssBase.showObjectLabel(this.container, sText, 'C', obj.x1, obj.y1, obj.x2, obj.y2);
		}
	};
