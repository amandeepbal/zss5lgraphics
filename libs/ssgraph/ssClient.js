...
sap.ui.define([
	...
	"zss5lgraphics/libs/ssgraph/windows/ssPentoid",
	...
	"zss5lgraphics/libs/ssgraph/roofsystem/ssRoofPost",
	...
	ssTrapezoid, ssChoppedTrapezoid, ssPentoid,
	...
	ssWall, ssWallSystem,
	ssRoofSystem, ssRoof, ssRoofPanel, ssRoofPost,
	...
	return function (id, data) {
		...
		this.draw = function (data, x, y, acanvas) {
			...
			if (data.model.Content === undefined) {
				return;
			}
			if (data.model.Content.general.shape === undefined) {
				return;
			}
			...
			case "CHOPPEDTRAPEZOID":
				...
				break;
			case "PENTOID":
				return new ssPentoid(this, data, canvas, x, y).render();
				break;
			case "SUNSHADE":
			...
			case "ROOFPANEL":
				...
				break;
			case "ROOFPOST":
				return new ssRoofPost(this, data, canvas, x, y).render();
				break;
			case "FLOORSYSTEM":
		...
		this.hliteObject = function (me) {
			...
			if (this.modelInstance != me.instanceId) {
				return;
			}
			if (this.parentInstance === undefined) {
				//				return;
			}
			if (this.modelInstance === this.parentInstance) {
				//				return;
			}
